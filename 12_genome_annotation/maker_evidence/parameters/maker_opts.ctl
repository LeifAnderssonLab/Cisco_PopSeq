...
max_dna_len=110000 #length for dividing up contigs into chunks (increases/decreases memory usage)
...
split_hit=35000 #length for the splitting of hits (expected max intron size for evidence alignments)
