# 07_2 fst_pi_10kwin_only_signal_spring_vs_autumn
...
#SBATCH --array=1-3
#SBATCH -J Pi_canditate_spring
#SBATCH -e Pi_canditate_spring_%A_%a.err
#SBATCH -o Pi_canditate_spring_%A_%a.out
...
for POP in `ls $BAM_LIST/Pi_2*.list`; do
POP_TARGET=${POP/.list/}
...
GENE_LIST=/proj/snic2020-2-19/private/cisco/qiaoling/Bam_Files/ANGSD_analysis/Beagle_file/2_MAF_005/0_FST_pi/0_only_signal/3_canditate_gene/canditate_spring.list
...
#SBATCH --array=1-3
#SBATCH -J fst_spring
#SBATCH -e fst_spring_%A_%a.err
#SBATCH -o fst_spring_%A_%a.out
#SBATCH --mail-type=all
#SBATCH --mail-user=qiaoling.deng@outlook.com
...
FST_LIST_1=$List_DIR/Fst_2_Autumn
FST_LIST_2=$List_DIR/Fst_2_Spring
